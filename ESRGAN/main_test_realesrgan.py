...
def main():
    ...
    parser.add_argument(
        '--model_path', type=str, default="/content/drive/MyDrive/URetinex-Net-main/demo/realesrgan_pt_weight/Real-ESRGAN-master/experiments/finetune_RealESRGANx4plus_400k_pairdata/models/net_g_15000.pth", help='[Option] Model path. Usually, you do not need to specify it')
    ...
    else: # default is RealESRGAN_x4plus
        model = RRDBNet(num_in_ch=3, num_out_ch=3, num_feat=64, num_block=23, num_grow_ch=32, scale=4)
        netscale = 4
        #file_url = ['https://github.com/xinntao/Real-ESRGAN/releases/download/v0.1.0/RealESRGAN_x4plus.pth']
