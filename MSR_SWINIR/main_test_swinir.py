...
#     #                     default='/content/drive/MyDrive/Super_Resolution_code/KAIR-master/superresolution/swinir_sr_classical_patch48_x2/models/10000_G.pth')
#     parser.add_argument('--model_name', type=str, default='swinir')
#     parser.add_argument('--model_path', type=str,
#                         default='/content/drive/MyDrive/Super_Resolution_code/KAIR-master/pretrained_weights/001_classicalSR_DF2K_s64w8_SwinIR-M_x4.pth')
...
#         print(f"img shape={img_lq.shape}")
#         # inference
#         with torch.no_grad():
...
#         cv2.imwrite(f'/content/drive/MyDrive/Super_Resolution_code/KAIR-master/superresolution/super_resolution_result/{imgname}_{model_name}.png', output)
...
#     print(f"imgname={imgname} imgext={imgext}")
...
#                 print(f"in_patch shape = {in_patch.shape}")
...
def main():
    ...
    parser.add_argument('--folder_lq', type=str, default="/content/drive/MyDrive/Super_Resolution_code/KAIR-master/testsets/hr_tests", help='input low-quality test image folder')
    parser.add_argument('--folder_gt', type=str, default=None, help='input ground-truth test image folder')
    parser.add_argument('--file_name', type=str, default=None, help='specific file name to do sr')
    parser.add_argument('--tile', type=int, default=None, help='Tile size, None for no tile during testing (testing as a whole)')
    parser.add_argument('--tile_overlap', type=int, default=32, help='Overlapping of different tiles')
